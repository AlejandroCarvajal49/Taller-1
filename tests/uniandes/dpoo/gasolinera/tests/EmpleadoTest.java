...
public class EmpleadoTest
{
    ...
    void testEmpleado( )
    {
        Assertions.assertEquals( "e1", e1.getNombre( ), "El nombre del empleado no es el correcto" );
        Assertions.assertEquals( 0, e1.getCantidadDinero( ), "El nuevo empleado no debería tener dinero" );
    }
